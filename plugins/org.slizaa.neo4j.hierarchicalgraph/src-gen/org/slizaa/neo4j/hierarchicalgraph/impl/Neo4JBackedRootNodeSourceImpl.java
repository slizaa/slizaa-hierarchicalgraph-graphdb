...
public class Neo4JBackedRootNodeSourceImpl extends Neo4JBackedNodeSourceImpl implements Neo4JBackedRootNodeSource {
   ...
   * @ordered
   */
  protected Neo4jClient repository;
   ...
   * @generated
   */
  public Neo4jClient getRepository() {
    if (repository != null && repository.eIsProxy()) {
      InternalEObject oldRepository = (InternalEObject)repository;
      repository = (Neo4jClient)eResolveProxy(oldRepository);
   ...
   * @generated
   */
  public Neo4jClient basicGetRepository() {
    return repository;
  }
   ...
   * @generated
   */
  public void setRepository(Neo4jClient newRepository) {
    Neo4jClient oldRepository = repository;
  ...
  public void eSet(int featureID, Object newValue) {
    switch (featureID) {
      case Neo4jHierarchicalgraphPackage.NEO4_JBACKED_ROOT_NODE_SOURCE__REPOSITORY:
        setRepository((Neo4jClient)newValue);
        return;
    }
  ...
  public void eUnset(int featureID) {
    switch (featureID) {
      case Neo4jHierarchicalgraphPackage.NEO4_JBACKED_ROOT_NODE_SOURCE__REPOSITORY:
        setRepository((Neo4jClient)null);
        return;
    }
