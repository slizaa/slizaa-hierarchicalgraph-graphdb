...
//  private DbAdapterRegistry    _dbAdapterRegistry;
  ...
  public void execute(List<?> selection, Viewer viewer) {
    ...
    // //
    // for (Neo4jClient managedNeo4jInstance : _dbAdapterRegistry.getDbAdapterContainer(ContainerType.MANAGED)
    // .getChildren()) {
    ...
    // }
    //
    // for (Neo4jClient restClient : _dbAdapterRegistry.getDbAdapterContainer(ContainerType.UNMANAGED).getChildren()) {
