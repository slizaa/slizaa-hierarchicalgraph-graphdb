...
public class CustomProxyDependencyResolver implements IProxyDependencyResolver {
  ...
  public List<Future<?>> resolveProxyDependency(final HGProxyDependency dependency) {
    ...
    //
    Neo4jClient neo4jRepository = dependency.getRootNode().getExtension(Neo4jClient.class);
   ...
   * @return
   */
  private Future<?> createFutureForQuery(Neo4jClient neo4jRepository, final HGProxyDependency dependency,
    ...
    return neo4jRepository.executeCypherQuery(normalizedCypherQuery, params, queryResult -> {
      ...
      //
      List<GraphFactoryFunctions.Neo4jRelationship> dependencyDefinitions = queryResult
